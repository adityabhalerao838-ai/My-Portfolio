...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Personal portfolio: projects, skills, and what I'm building." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Aditya Bhalerao — CS Student & Developer" },
      { name: "twitter:description", content: "Personal portfolio: projects, skills, and what I'm building." },
    ],
    links: [
